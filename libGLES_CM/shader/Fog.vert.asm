...
add o2.xyzw, v2.xyzw, c6.xyzw	# TexCoord0=o2.xyzw, MultiTexCoord0=v2.xyzw, TexShift0=c6.xyzw
dp4 o3.x, v0.xyzw, c7.xyzw	# Vertex=v0.xyzw, ModelViewZ=c7.xyzw
label main_end
mov o1.xyzw, v1.xyzw
ret
# 8 instructions, 9 C regs, 1 R regs 
