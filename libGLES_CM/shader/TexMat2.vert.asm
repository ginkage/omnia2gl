...
dp4 o2.x, v2.xyzw, c10.xyzw	# MultiTexCoord1=v2.xyzw
dp4 o2.y, v2.xyzw, c11.xyzw	# MultiTexCoord1=v2.xyzw
dp4 o2.z, v2.xyzw, c12.xyzw	# MultiTexCoord1=v2.xyzw
dp4 o2.w, v2.xyzw, c13.xyzw	# MultiTexCoord1=v2.xyzw
label main_end
ret
# 13 instructions, 15 C regs, 1 R regs 
